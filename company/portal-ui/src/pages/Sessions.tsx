...
export default function SessionsPage() {
  ...
  const { data, loading, error, refetch } = useApiCall((api) => api.getSessions(params), [from, to, status, tenantId, page]);
  ...
  return (
    <div className="space-y-6">
      ...
      {data && data.items.length === 0 && <p className="text-muted-foreground text-sm">No sessions found.</p>}
