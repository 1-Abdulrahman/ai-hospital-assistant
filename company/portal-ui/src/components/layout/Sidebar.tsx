...
const allLinks = [
  ...
  { to: '/tenants', label: 'Tenants', icon: Building2, comingSoon: true },
  { to: '/audit', label: 'Audit Logs', icon: FileText, comingSoon: true },
  { to: '/traces', label: 'Traces', icon: GitBranch },
  { to: '/sessions', label: 'Sessions', icon: MessageSquare },
  { to: '/nlp-monitoring', label: 'NLP Monitoring', icon: Brain, comingSoon: true },
];
